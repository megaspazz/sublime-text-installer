...
def build_comment_data(view, pt):
    ...
    # USER ADDED: strip the trailing space in start of certain comments
    if ("TM_COMMENT_START" in all_vars and not("TM_COMMENT_END" in all_vars)):
        all_vars["TM_COMMENT_START"] = all_vars["TM_COMMENT_START"].rstrip()
    # END SECTION
